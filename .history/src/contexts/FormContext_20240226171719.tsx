...
export interface MeetingContextDataProps {
  ...
  handleAddEmail: () => void;
  handleRemoveEmail: (index: number) => void; // Adicionando a função para remover email
...
export const FormProvider = ({ children }: MeetingContextProviderProps) => {
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    // Verifica se a data, hora e emails já estão sendo usadas
  ...
  return (
    <FormContext.Provider
      value={{
        ...
        handleAddEmail,
        handleRemoveEmail, // Passando a função handleRemoveEmail para o contexto
        handleSubmit,
      }}
    >
      {children}
