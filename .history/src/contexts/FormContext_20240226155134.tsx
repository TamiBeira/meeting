...
export interface MeetingContextDataProps {
  ...
  emails: string[];
  emailInput: string;
  handleInputChange: (event: ChangeEvent<HTMLInputElement>, setterFunction: Function) => void;
...
export const FormProvider = ({ children }: MeetingContextProviderProps) => {
  ...
  const handleInputChange = (event: ChangeEvent<HTMLInputElement>, setterFunction: React.Dispatch<React.SetStateAction<string>>) => {
