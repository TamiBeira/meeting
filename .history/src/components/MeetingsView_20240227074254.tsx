...
export const MeetingsView: React.FC = () => {
  ...
  return (
    <div className=" flex-col items-center bg-gray-900 h-screen mx-auto justify-center">
      ...
      <ul>
        ...
        {meetings.map((meeting, index) => (
          <li key={index} className={`border-b border-gray-200 py-4 flex flex-col sm:flex-row justify-center items-center max-w-5xl`}>
            {editableIndex === index ? (
              <>
                <input
                  type="text"
