...
import { FaEdit, FaTrash } from 'react-icons/fa'; // Importando ícones do Font Awesome
              ...
              <>
                ...
                <div className="ml-4">
                  <button
                    ...
                    className=" text-blue font-bold py-1 px-2 mr-2 rounded flex items-center mb-2 justify-center"
                  >
                    <FaEdit className="mr-1" />
                  </button>
                  <button
                    onClick={() => handleDelete(index)}
                    className="bg-red-500 hover:bg-red-700 text-red-500 font-bold py-1 px-2 rounded flex items-center"
                  >
