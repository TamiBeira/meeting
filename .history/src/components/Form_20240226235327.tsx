  ...
  return (
    <main className="flex flex-col items-center mt-8">
      <div className="mt-4 mb-4">
        <Link to="/meetings" className="w-48 inline-block text-center border border-solid border-blue-500 text-blue-500 font-bold mr-2 px-4 py-2 rounded">Reuniões Cadastradas</Link>
        <Link to="/" className="w-48 inline-block text-center border border-solid border-blue-500 text-blue-500 font-bold px-4 py-2 rounded">Home</Link>
      </div>
