...
export const MeetingsView: React.FC = () => {
  ...
  return (
    <div className="flex flex-wrap items-center bg-gray-900 w-full h-screen justify-center">
      <h2 className="text-2xl text-white font-bold mb-4 w-full">Lista de Reuniões</h2>
