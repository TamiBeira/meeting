...
export const MeetingsView: React.FC = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto mt-8">
      ...
      <div className="mt-4">
      <Link to="/meetings" className="border border-solid border-blue-500 text-blue-500 font-bold mr-2 px-4 py-2 rounded">Ver Reuniões Cadastradas</Link>
      <Link to="/" className="border border-solid border-blue-500 text-blue-500 font-bold px-4 py-2 rounded">Voltar para a Página Inicial</Link>
      </div>
      <ul>
