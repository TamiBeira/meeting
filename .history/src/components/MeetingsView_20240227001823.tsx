...
export const MeetingsView: React.FC = () => {
  ...
  return (
    <div className="mx-auto bg-gray-900 w-full h-screen p-5 flex-col">
      ...
      <ul>
        <li className="border-b border-gray-200 py-2 flex sm:flex-row font-semibold max-w-5xl">
        ...
        {meetings.map((meeting, index) => (
          <li key={index} className="max-w-5xl border-b border-gray-200 py-4 flex flex-col sm:flex-row justify-center items-center">
            {editableIndex === index ? (
              <>
                <input
                  type="text"
                  ...
                  className="mb-2 text-white sm:mb-0 mr-4 px-4 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 max-w-28"
                  placeholder="Título"
                />
                <input
                  type="date"
                  ...
                  className="mb-2 text-white sm:mb-0 mr-4 px-4 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                />
                <input
                  type="time"
