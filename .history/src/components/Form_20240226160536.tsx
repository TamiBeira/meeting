...
import { ToastContainer } from 'react-toastify'; // Importando ToastContainer corretamente
  ...
  return (
    <main className="flex justify-center mt-8">
      <div className="mx-auto max-w-md p-6 bg-gray-100 rounded-lg shadow-xl">
        ...
        <ToastContainer /> {/* Certifique-se de que o ToastContainer está sendo usado aqui */}
      </div>
    </main>
  );
};