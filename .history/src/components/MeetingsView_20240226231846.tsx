...
export const MeetingsView: React.FC = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto mt-8 w-full"> {/* Adicionado mx-auto para centralizar horizontalmente */}
              ...
              <>
                ...
                <div className="w-1/5">
                  <button
                    ...
                    className="text-blue-500 font-bold flex-1 justify-center"
                  >
