            ...
            {editableIndex === index ? (
              <>
                ...
                <input
                  ...
                  className="mb-2 sm:mb-0 mr-4 px-4 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 whitespace-pre-wrap w-40"
                  placeholder="E-mails"
                />
                <div>
                  <button
