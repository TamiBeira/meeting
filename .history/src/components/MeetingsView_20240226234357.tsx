  ...
  return (
    <div className="max-w-5xl mx-auto mt-8">
      ...
      <ul>
        ...
        <div className="w-1/5 text-center">Título</div>
        <div className="w-1/5 text-18">Data</div>
        <div className="w-1/5 text-18">Hora</div>
        <div className="w-1/5 text-18">Imagem</div>
        <div className="w-1/5 text-18">E-mails</div>
        <div className="w-1/5 text-18">Editar</div>
        <div className="w-1/5 text-18">Excluir</div>
