Para adicionar o link "Você também pode acessar a aplicação online através deste link: Meeting App" ao README.md, você pode simplesmente adicioná-lo logo após a seção de execução. Aqui está como ficaria:
